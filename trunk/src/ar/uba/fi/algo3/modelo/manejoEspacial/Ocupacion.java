...
public interface Ocupacion {
	...
	/**
	 * 
	 * @param ocupacion objeto de la clase Ocupacion con respecto a la cual 
	 *  compararemos a esta instancia
	 * @return true si los objetos comparados coinciden espacialmente y false 
	 ...
	 * @param ocupacion objeto de la clase Ocupacion con respecto a la cual 
	 *  compararemos a esta instancia
	 * @return true si los objetos tiene coincidencia ocupacional en sus 
	 *  respectivas proyecciones en el eje x
	 */
	 ...
	 *  compararemos a esta instancia
	 * @return true si los objetos tiene coincidencia ocupacional en sus 
	 *  respectivas proyecciones en el eje y
	 */
	public abstract boolean coincidenciaProyeccionVerticalCon(Ocupacion ocupacion);
	
	/**
	 * Nos dice si la ocupación esta mapeada dentro de los límites espaciales 
	 *  del espacio.
	...
	/**
	 * 
	 * @return true si la ocupación está en alguno de los bordes del espacio 
	...
	/**
	 * 
	 * @return true si la ocupación está en alguno de los bordes horizontales 
	 *  del espacio y false en el caso contrario
	 */
	...
	/**
	 * 
	 * @return true si alguna de las posiciones de la ocupación coincide con 
	 *  alguna de las posiciones de la recta imaginaria que atraviesa el 
	 *  espacio verticalmente por su mitad, y false en el caso contrario
	 */
	...
	/**
	 * PARA RESPETAR EL POLIMORFISMO Y EL ENCAPSULAMIENTO, ES NECESARIO 
	 * QUE LAS OCUPACIONES SEPAN COMPARARSE ENTRE ELLAS Y QUE DE AFUERA 
	 * SE INVOQUE SENCILLAMENTE A coincidenciaOcupacionalCon(Ocupacion ocupacion).
	 * PARA ESTO ES NECESARIO QUE CADA OCUPACIÓN DEFINA UN MÉTODO QUE 
	 * LA COMPARE CON ELLA MISMA Y CON CADA UNA DE LAS OTRAS, QUE SERÁ 
	 * INVOCADO INTERNAMENTE.
	 * EN PRINCIPIO TENEMOS SÓLO UNA OCUPACIÓN CUADRADA, POR LO TANTO 
	 * SÓLO ES NECESARIO UN MÉTODO   
	 */
	...
	/**
	 * Devuelve una instancia de la clase posición que esté centrada con 
	 * respecto a esta ocupación, espacialmente pegada a su perímetro, 
	 * en la posición relativa dada por el parámetro
	 * @param orientacion posición relativa a esta ocupación en la que 
	 * queremos que esté el punto devuelto
	 * @return instancia de la clase posición que esté centrada con 
	 * respecto a esta ocupación, espacialmente pegada a su perímetro, 
	 * en la posición relativa dada por el parámetro
	 */
