...
public class PruebasIntegracionMirageTank extends TestCase {
	 ...
	 * Hago correr la l�gica del juego hasta que el tanque del jugador disminuya su resistencia considerablemente (notar que esta no puede anularse dado que el lanza cohetes quita la mitad de la resistencia actual de los tanques, por lo cual nunca es 0).
