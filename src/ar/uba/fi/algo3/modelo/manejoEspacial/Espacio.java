...
public class Espacio {
     ...
     * al espacio. Nos dice si la ocupaci�n de dicho objeto coincide con la de alg�n 
     * otro ya agregado.
	 ...
	 * objetos de este espacio y que se encuentra lo m�s arriba posible dentro del 
	 * espacio.
	 * @param lado entero correspondiente al lado que queremos que tenga la ocupaci�n 
	 * cuadrada
